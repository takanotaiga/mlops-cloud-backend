...
DEFAULT_STEPS: List[Dict[str, str]] = [
    ...
    {"key": "rtdetr_train", "label": "DETR train", "state": StepState.PENDING},
    {"key": "trt_export", "label": "Model export", "state": StepState.PENDING},
    {"key": "rtdetr_infer", "label": "DETR inference", "state": StepState.PENDING},
